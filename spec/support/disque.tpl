...
# Note that Disque will write a pid file in /usr/local/var/run/disque.pid when daemonized.
daemonize yes

# When running daemonized, Disque writes a pid file in /usr/local/var/run/disque.pid by
